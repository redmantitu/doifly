    ...
    (
      <div
        style={{
          ...
          background:
            "radial-gradient(circle at 30% 24%, rgba(76,168,255,0.28), transparent 36%), linear-gradient(180deg, #08111c 0%, #10273e 100%)",
          borderRadius: 104,
        }}
      >
        <svg width="390" height="390" viewBox="0 0 512 512" fill="none">
